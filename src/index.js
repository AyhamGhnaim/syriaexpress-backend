...
app.get('/api/health', (req, res) => {
  // version = علامة نشر: تؤكّد أن كود B5 (اقتراحات إعادة الطلب التنبؤية) حيّ على الخادم
  res.json({ status: 'ok', message: 'SyriaExpress API is running 🚀', version: 'b5-reorder', time: new Date() });
});
