...
app.get('/api/health', (req, res) => {
  // version = علامة نشر: تؤكّد أن كود B3 (إشعارات + إغلاق IDOR الحالة) حيّ على الخادم
  res.json({ status: 'ok', message: 'SyriaExpress API is running 🚀', version: 'b3-notifications', time: new Date() });
});
